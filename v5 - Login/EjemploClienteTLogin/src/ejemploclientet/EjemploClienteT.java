...
public class EjemploClienteT {
    ...
    private String getContra() {
        return JOptionPane.showInputDialog(frame, "Elige una contraseña: ", "Selección de contraseña", JOptionPane.PLAIN_MESSAGE
        );
    }
    
    private String getNombre2() {
        return JOptionPane.showInputDialog(frame, "Ingrese nombre de usuario: ", "Ingresar nombre", JOptionPane.PLAIN_MESSAGE
        );
    }
    
    private String getContra2() {
        return JOptionPane.showInputDialog(frame, "Ingrese su contraseña: ", "Ingresar contraseña", JOptionPane.PLAIN_MESSAGE
        );
    }
    
    private void inicio() {
        int respuesta = JOptionPane.showConfirmDialog(frame, "¿Quieres registrarte?", "Inicio", JOptionPane.YES_NO_OPTION);
    ...
    private void eliminarUsuario() {
        int respuesta = JOptionPane.showConfirmDialog(frame, "¿Estás seguro de eliminar tu cuenta?", "Eliminación de cuenta", JOptionPane.YES_NO_OPTION);
        if (respuesta == JOptionPane.YES_OPTION) {
            out.println("si");
        } else {
            out.println("no");
    ...
    private void iniciar() {
        try {
            ...
            while (in.hasNextLine()) {
                ...
                } else if (line.startsWith("2SUBMITNAME")) {
                    out.println(getNombre2());
                } else if (line.startsWith("2SUBMITPASSWORD")) {
                    out.println(getContra2());
